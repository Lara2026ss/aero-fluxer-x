...
| **DEC-001** | Desacoplamiento Total de Servicios Externos | **PASS** | Cero dependencia de tokens o APIs externas en runtime; sin colisión con cuentas ni fallos de autorización a terceros. |
