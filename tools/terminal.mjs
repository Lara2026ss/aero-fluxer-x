...
export function createTerminalDomain({ runtime, path, fs, crypto, domain }) {
  ...
  const permissions = {
    ...
    execute_command: "advanced",
    exec: "advanced",
    command: "advanced",
    execute: "advanced",
    run_background: "advanced",
    run_script: "advanced",
    run_inline_script: "advanced",
    run_as_admin: "maintainer",
    admin_terminal: "maintainer",
    terminal_admin: "maintainer",
    run_admin_command: "maintainer",
    kill_process: "advanced",
    kill_process_tree: "advanced",
    kill_background_task: "advanced",
    run_session_command: "advanced",
    open_url: "standard",
    open_file_explorer: "standard",
    create_session: "standard",
    attach_session: "standard",
    close_session: "standard",
    list_sessions: "standard",
    list_background_tasks: "standard",
    get_background_output: "standard",
    wait_for_background_task: "standard",
    list_processes: "standard",
  };
